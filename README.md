...
- 'fsigma', the time evolution of the fractional deviation (between the STSQ and the LambdaCDM models) of the fsigma growth parameter.
- 'gammas', the time evolution of the fractional deviation (between the STSQ and the LambdaCDM models) of the gamma growth parameter.
- 'lumdis', the time evolution of the fractional deviation (between the STSQ and the LambdaCDM models) of the luminosity distance.
