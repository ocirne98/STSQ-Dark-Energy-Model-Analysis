...
from pylab import plot,xlabel,ylabel,show,legend,hlines,xlim,savefig,axhspan,tick_params,figure
...
legend([r'$z_c (STSQ)=12$',r'$z_c (STSQ)=15$',r'$z_c (STSQ)=17$',r'$\Lambda$''CDM','EUCLID aggregate error\'s span'],fontsize=20)
show()
#savefig('gammas(z).pdf', format='pdf', dpi=1200)