...
for i in range(3):
    ...
    z_cs = [12,15,17] #z_c different values
    colors = ['g','b','c']

    stsq_model = model(z_i, z_cs[i], N, eta, True)
...
xlim([0.2, 1.7])
legend([r'$z_c = 12$',r'$z_c = 15$',r'$z_c = 17$','WFIRST 1$\sigma$ aggregate error'],fontsize=15)
show()
#savefig('lumdis(z).pdf', format='pdf', dpi=1200)